...
if __name__ == '__main__':
    ...
    self_model = load_model('models/j_eff3_model.h5')
    ...
    hold = np.load("models/j_hold_vector.npy") ###

    # 正解ラベル
    label = ['hojicha', 'cola', 'gogotea', 'namacha',  'pocali', 'unknown']

    # 商品価格
    money = {'hojicha':150, 'cola':100, 'gogotea':130, 'namacha':200,
             'pocali':140, 'unknown':0}
...
# 「いらっしゃいませ」の音声
    ...
    while True:
        ...
        while True:
            ...
            jd = judgment(predict_vector=img_pred, hold_vector=hold, thresh=0.93) ###
            ######
            name=label[jd]
